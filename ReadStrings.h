...
void write_strings(struct string* data, const size_t len, const size_t num_data_elem, const char* name_file_output);
...
int convert_str_to_int(const string s, int l, int r, int* a);
